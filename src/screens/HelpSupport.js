...
import { View, Text, Pressable, TextInput, StyleSheet, ScrollView, Linking } from 'react-native';
...
export const Help = ({ navigation }) => {
  ...
  const enviarCorreo = () => {
    ...
    const cuerpo = `Tipo de Solicitud: ${selectedSolicitud}\n` +
  ...
  return (
    <View style={AppStyles.containerHelp}>
      ...
      <ScrollView style={AppStyles.scrollViewHelp} contentContainerStyle={AppStyles.scrollContent}>
